...
#Load data
mydata <- read.csv("C:/Users/oisin/Desktop/Analysis Data/MS project/MS data sheet 1.csv", sep = ";", header = F,)
...
#LVQ 
train.lvq <- trainControl(method = "repeatedcv", number = 10, repeats = 5, search = "random")
set.seed(86)
lvq <- train(Samples ~ .,
...
elastic.predictors.Sig <- head(elastic.predictors, 0)
...
print(venn.intersect.predictors$a2)
#############################################################
